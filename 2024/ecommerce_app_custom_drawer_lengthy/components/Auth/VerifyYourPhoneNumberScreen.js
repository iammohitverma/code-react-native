...
const VerifyYourNumberScreen = ({ navigation }) => {
  ...
  const verifyYourNumber = () => {
    Alert.alert('Message','check number and hid this view and show the otp view')
  };
      ...
      <SafeAreaView  style={[ThemeStyle.mainWrapper,ThemeStyle.forGotWrapper]}>
        <ScrollView>
          <View style={[ThemeStyle.forGotBox]}>
            <View>
              <Text style={[ThemeStyle.LSdesc , ThemeStyle.testLeft]}>We have sent you an SMS with a code to number +17 0123456789.</Text>
            </View>
            ...
            <View style={[ThemeStyle.formLabel]}>
              ...
              > 
                <Text style={[ThemeStyle.GsMainButtonText,ThemeStyle.LSmainButton]}>CONFIRM</Text>
              </TouchableOpacity>
            </View>
          ...
          <View style={[ThemeStyle.forGotBox]}>
            <View>
              <Text style={[ThemeStyle.LSdesc , ThemeStyle.testLeft]}>Enter your OTP code here.</Text>
            </View>
            ...
            <View style={[ThemeStyle.formLabel]}>
              ...
              > 
                <Text style={[ThemeStyle.GsMainButtonText,ThemeStyle.LSmainButton]}>VERIFY</Text>
              </TouchableOpacity>
            </View>
            ...
            <View style={[ThemeStyle.formLabel]}>
              <View style={[ThemeStyle.dhaLabel]}>
                <Text style={[ThemeStyle.dhaLabelText]}>Didn’t receive the OTP? </Text>
                <TouchableOpacity 
                  style={ThemeStyle.forGotBtn}
                  onPress={ResendOtp}  // Trigger navigation on button press
                > 
                    <Text style={[ThemeStyle.dhaLabelText,ThemeStyle.dhaLabelLightText]}>Resend.</Text>
                </TouchableOpacity>
              </View>
            </View>
