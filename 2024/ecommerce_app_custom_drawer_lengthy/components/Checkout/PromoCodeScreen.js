      ...
      <View  style={[ThemeStyle.mainWrapper,ThemeStyle.MessageScreenWrap]}>
          <View style={[ThemeStyle.MessageScreenBox]}>
            <Image
                ...
                source={iconHero}
              />
            <Text style={ThemeStyle.MessageScreenHdng}>Your don't have promocodes yet!</Text>
            <Text style={ThemeStyle.MessageScreenDesc}>Qui ex aute ipsum duis. Incididunt adipisicing voluptate laborum</Text>
          </View>
          ...
          <View style={[ThemeStyle.forGotBox,ThemeStyle.voucherFormBox]}>
            ...
            <View style={[ThemeStyle.formLabel]}>
              ...
              > 
                <Text style={[ThemeStyle.GsMainButtonText,ThemeStyle.LSmainButton]}>SUBMIT</Text>
              </TouchableOpacity>
            </View>
