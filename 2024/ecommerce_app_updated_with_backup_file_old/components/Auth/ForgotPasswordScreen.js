      ...
      <SafeAreaView  style={[ThemeStyle.mainWrapper,ThemeStyle.forGotWrapper]}>
        <ScrollView>
          <View style={[ThemeStyle.forGotBox]}>
            <View>
              <Text style={[ThemeStyle.LSdesc , ThemeStyle.testLeft]}>Please enter your email address. You will receive a link to create a new password via email.</Text>
            </View>
            ...
            <View style={[ThemeStyle.formLabel]}>
              ...
              > 
                <Text style={[ThemeStyle.GsMainButtonText,ThemeStyle.LSmainButton]}>SEND</Text>
              </TouchableOpacity>
            </View>
