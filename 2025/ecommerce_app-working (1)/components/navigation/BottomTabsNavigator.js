...
// import AdityaScreens from "../../components/Pages/AdityaScreens";
  ...
  return (
      ...
      screenOptions={({ route }) => ({
        tabBarIcon: ({ focused, color, size }) => {
          ...
          if (route.name === "Home") {
            ...
            iconSource = focused
              ? require("../../assets/images/CategoriesActive.png")
          ...
          } else if (route.name === "AdityaScreens") {
            iconSource = focused
              ? require("../../assets/images/ProfileActive.png")
              : require("../../assets/images/Profile.png");
          }
    ...
    >
      ...
      <BottomTab.Screen
        ...
        options={{ title: "Categories", header: () => null }}
      />
      <BottomTab.Screen
        name="Cart"
